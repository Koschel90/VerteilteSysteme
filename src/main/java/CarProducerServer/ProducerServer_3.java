...
public class ProducerServer_3 extends Thread{
  ...
  public void connectionToProducerServer_1(){
    try {
      // Set port
      TServerSocket serverTransport = new TServerSocket(9900);
  ...
  public static void main(String[] args) {
    ProducerServer_3 s3 = new ProducerServer_3();
    s3.start();
    System.out.println("Starting Producer Server 3 ...");
  }
}